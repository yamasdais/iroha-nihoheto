...
void test_projection() {
    ...
    constexpr auto less = cpc::make_projection<foo const&, foo const&>(std::less<int>{}, &foo::num);
    ...
    cpc::prior_que q{cont, std::less<int>{}, &foo::num};
    q.emplace(5, "baz");
...
void test0() {
    ...
    constexpr auto less = cpc::make_projection<int, int>(std::less<int>{}, std::identity{});
    //auto err_prj = cpc::make_projection<int, int>(std::less<int>{}, &foo::num);
    //cpc::trace_type(q);
    //cpc::trace_type(less);
    //int i0 = 2;
